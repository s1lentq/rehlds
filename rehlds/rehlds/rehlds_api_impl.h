...
typedef IVoidHookChainImpl<netsrc_t, netadr_t &, int, unsigned char *> CRehldsHook_Netchan_OutOfBand;
typedef IVoidHookChainRegistryImpl<netsrc_t, netadr_t &, int, unsigned char *> CRehldsHookRegistry_Netchan_OutOfBand;
...
public:
	...
	CRehldsHookRegistry_Netchan_OutOfBand m_Netchan_OutOfBand;
...
public:
	...
	EXT_FUNC virtual IRehldsHookRegistry_Netchan_OutOfBand* Netchan_OutOfBand();
};
